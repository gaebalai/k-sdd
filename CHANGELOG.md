...
- [Korean](docs/RELEASE_NOTES/RELEASE_NOTES_ko.md)
...
- Remove the README Amazon book reference after the linked title shifted to promote `ai-sdd`, a closed-source clone of k-sdd without attribution ([#157](https://github.com/gaebalai/k-sdd/pull/157))

### Fixed

- Add the missing `description` field to the Codex `spec-reviewer` custom agent template so Codex keeps the role available for cross-spec review instead of dropping it as malformed ([#160](https://github.com/gaebalai/k-sdd/pull/160))

## [3.0.1] - 2026-04-11

### Changed

- Refine English release messaging by replacing the awkward phrase `team-scale AI-driven development` with `AI-driven development at team scale` across the main README and philosophy guide ([#155](https://github.com/gaebalai/k-sdd/pull/155))

### Fixed

- Correct the mojibake in the Claude Code Skills `kiro-impl` template so the feature-flag test protocol renders the `→` arrow correctly ([#154](https://github.com/gaebalai/k-sdd/pull/154))

### Security

- Harden manifest-, template-, and shared-rule-derived path handling so generated file operations stay within the expected roots and fail closed on unsafe traversal inputs or symlinked destinations ([#155](https://github.com/gaebalai/k-sdd/pull/155))

## [3.0.0] - 2026-04-10

### Added

- Introduce Agent Skills mode as the primary installation target across 8 platforms: Claude Code, Codex, Cursor, GitHub Copilot, Windsurf, OpenCode, Gemini CLI, and Antigravity ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Add new workflow entry points for skills mode, including `/kiro-discovery`, `/kiro-spec-batch`, and long-running autonomous `/kiro-impl` with reviewer/debugger support ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Add `.kiro/settings/` rules and templates for boundary-first planning, design synthesis, review gates, task decomposition, and steering customization ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Add `k-sdd-new-agent`, a plan-first SOP for adding new supported agents or migrating existing agents to skills mode ([#141](https://github.com/gaebalai/k-sdd/pull/141))

### Changed

- Reposition k-sdd around skills-mode workflows and native subagent dispatch, with updated docs, guides, and onboarding across the repository ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Change the default installer target from command-based Claude Code to `claude-code-skills` ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Update the package positioning to “long-running autonomous implementation” and align README / release messaging with the v3 workflow ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Restrict stale issue auto-close behavior so only maintainers who explicitly apply the `awaiting-response` label trigger timeout-based closure ([#138](https://github.com/gaebalai/k-sdd/pull/138))

### Deprecated

- Deprecate command-based agent installs such as `--claude-code`, `--cursor`, and related prompt-mode variants in favor of `--*-skills` installs ([#141](https://github.com/gaebalai/k-sdd/pull/141))

### Removed

- Remove Codex prompts mode as a supported install path; `--codex` now blocks and directs users to `--codex-skills` ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Remove the external Ralph Loop dependency in favor of native subagent-driven autonomous implementation inside `kiro-impl` ([#141](https://github.com/gaebalai/k-sdd/pull/141))

### Fixed

- Honor configured agent selection during non-interactive installs instead of forcing the default agent ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Accept CRLF frontmatter when resolving skill shared-rules so Windows-style checkouts install complete rule sets ([#141](https://github.com/gaebalai/k-sdd/pull/141))

## [2.1.1] - 2026-02-02

### Fixed

- Fix OpenCode agent slash command frontmatter to use full agent path ([#134](https://github.com/gaebalai/k-sdd/pull/134))

### Security

- Update vitest to v4 to resolve security vulnerabilities ([#135](https://github.com/gaebalai/k-sdd/pull/135))
...
- **OpenCode support** - 8th supported agent with full SDD workflow integration ([#117](https://github.com/gaebalai/k-sdd/pull/117), [#127](https://github.com/gaebalai/k-sdd/pull/127))
  ...
  - Installation via `npx k-sdd@latest --opencode` or `--opencode-agent`

### Changed

- Update recommended models to latest versions ([#128](https://github.com/gaebalai/k-sdd/pull/128), [#129](https://github.com/gaebalai/k-sdd/pull/129))
  - Claude: Opus 4.5
  - OpenAI: GPT-5.2
  - Google: Gemini 3 Flash
- Remove think keywords from templates for cleaner prompts ([#128](https://github.com/gaebalai/k-sdd/pull/128))
...
- Add Greek (el) language support, bringing total to 13 languages ([#121](https://github.com/gaebalai/k-sdd/pull/121))

## [2.0.4] - 2026-01-07

### Fixed

- Update GitHub Copilot prompt files to replace deprecated `mode` attribute with `agent` ([#118](https://github.com/gaebalai/k-sdd/pull/118))
- Fix registry.ts with review improvements ([#107](https://github.com/gaebalai/k-sdd/pull/107))

### Documentation

- Add AI-Assisted SDD book reference to documentation ([#109](https://github.com/gaebalai/k-sdd/pull/109))
...
- PRs: [#104](https://github.com/gaebalai/k-sdd/pull/104)
...
- PRs: [#102](https://github.com/gaebalai/k-sdd/pull/102)

## [2.0.1] - 2025-11-10

### Changed

- Improve README clarity and visual consistency ([#93](https://github.com/gaebalai/k-sdd/pull/93), [#94](https://github.com/gaebalai/k-sdd/pull/94))

## [2.0.0] - 2025-11-09

### Summary

- Consolidates every feature shipped in 2.0.0-alpha.1〜alpha.6 and promotes them to `npx k-sdd@latest`.
...
- **Parallel task analysis** by default in spec-tasks command ([#89](https://github.com/gaebalai/k-sdd/pull/89))
...
- **Claude Code Subagents mode** for context optimization ([#74](https://github.com/gaebalai/k-sdd/pull/74))
...
- **Interactive CLI installer** with guided setup ([#70](https://github.com/gaebalai/k-sdd/pull/70))
...
- **Comprehensive documentation**
  - Complete command reference with 11 `/kiro:*` commands ([#83](https://github.com/gaebalai/k-sdd/pull/83))
  - Customization guide with 7 practical examples ([#83](https://github.com/gaebalai/k-sdd/pull/83))
  - Migration guide for v1.x users
- **npm badges** for version tracking ([#86](https://github.com/gaebalai/k-sdd/pull/86))
...
- **Updated EARS format** to use lowercase syntax ([#88](https://github.com/gaebalai/k-sdd/pull/88))
  - Changed from "WHILE/WHEN/WHERE/IF" to "while/when/where/if"
  - Improved readability and consistency
- **Clarified template customization instructions** ([#85](https://github.com/gaebalai/k-sdd/pull/85))
- **Updated installation documentation** for better clarity ([#87](https://github.com/gaebalai/k-sdd/pull/87))
...
- **Automated GitHub issue lifecycle management** ([#80](https://github.com/gaebalai/k-sdd/pull/80))
  - Auto-close stale issues after 10 days of inactivity
  - Configurable stale detection workflow
  - English-only workflow messaging ([#81](https://github.com/gaebalai/k-sdd/pull/81))
- **Centralized agent metadata into registry** ([#72](https://github.com/gaebalai/k-sdd/pull/72))
...
- npm `next` version badge in README files ([#86](https://github.com/gaebalai/k-sdd/pull/86))
...
- [#88](https://github.com/gaebalai/k-sdd/pull/88) - Update EARS format to lowercase syntax
- [#87](https://github.com/gaebalai/k-sdd/pull/87) - Clarify installation
- [#86](https://github.com/gaebalai/k-sdd/pull/86) - Add npm next badge to README files

## [2.0.0-alpha.4] - 2025-10-30

### Added

- Comprehensive customization guide with 7 practical examples ([#83](https://github.com/gaebalai/k-sdd/pull/83))
  - Template customization patterns
  - Agent-specific workflow examples
  - Project-specific rule examples
- Complete command reference documentation ([#83](https://github.com/gaebalai/k-sdd/pull/83))
...
- Clarified template customization instructions ([#85](https://github.com/gaebalai/k-sdd/pull/85))
- Customization guide review improvements ([#84](https://github.com/gaebalai/k-sdd/pull/84))

**Related PRs:**

- [#83](https://github.com/gaebalai/k-sdd/pull/83) - Add customization guide and command reference
- [#84](https://github.com/gaebalai/k-sdd/pull/84) - Customization guide review suggestions
- [#85](https://github.com/gaebalai/k-sdd/pull/85) - Clarify template customization instructions
...
- [#80](https://github.com/gaebalai/k-sdd/pull/80) - Automate GitHub issue lifecycle management
- [#81](https://github.com/gaebalai/k-sdd/pull/81) - Make stale workflow messaging English-only

## [2.0.0-alpha.3] - 2025-10-22

### Added

- Windsurf IDE agent definition, manifest, and workflow templates so `npx k-sdd@next --windsurf` installs `.windsurf/workflows/` and AGENTS.md alongside shared settings.
...
- Refreshed root README, `tools/k-sdd/README*`, and `docs/README/README_{en,ko}.md` with Windsurf setup instructions and manual QA steps.
...
- [#74](https://github.com/gaebalai/k-sdd/pull/74) - Add Claude Code Subagents mode
- [#73](https://github.com/gaebalai/k-sdd/pull/73) - Add CLAUDE.md documentation
- [#72](https://github.com/gaebalai/k-sdd/pull/72) - Refactor agent metadata into central registry

## [2.0.0-alpha.1] - 2025-10-08

### Added

- Interactive CLI installer with guided setup (`npx k-sdd@latest`)
  - Organized file display by Commands / Project Memory / Settings categories
  - Interactive project memory handling (overwrite/append/keep)
- Codex CLI official support with 11 prompts in `.codex/prompts/`
- GitHub Copilot official support with 11 prompts in `.github/prompts/`
...
- [#71](https://github.com/gaebalai/k-sdd/pull/71) - Add alpha version info and improve language table
- [#70](https://github.com/gaebalai/k-sdd/pull/70) - Release k-sdd v2.0.0-alpha

## [1.1.5] - 2025-09-24

### Added

- Qwen Code AI assistant support ([#64](https://github.com/gaebalai/k-sdd/pull/64))
...
- Bash command errors in steering templates ([#62](https://github.com/gaebalai/k-sdd/pull/62))
...
- Improved steering command templates ([#60](https://github.com/gaebalai/k-sdd/pull/60))
  - Simplified custom files check logic using `ls + wc`
  - Added `AGENTS.md` to project analysis section

### Fixed

- Kiro IDE integration descriptions in READMEs ([#61](https://github.com/gaebalai/k-sdd/pull/61))
...
- Multi-language support for project memory documents ([#59](https://github.com/gaebalai/k-sdd/pull/59))
...
- Improved test coverage and fixed edge cases ([#57](https://github.com/gaebalai/k-sdd/pull/57))
...
- Validation commands for brownfield development ([#56](https://github.com/gaebalai/k-sdd/pull/56))
  - `/kiro:validate-gap` - Analyze implementation gap between requirements and existing codebase
  - `/kiro:validate-design` - Validate design compatibility with existing architecture
  - `/kiro:validate-impl` - Validate implementation against requirements, design, and tasks
- Cursor IDE official support with 11 commands
- AGENTS.md configuration file for Cursor IDE optimization
- Windows template support for Gemini CLI with proper bash -c wrapping ([#56](https://github.com/gaebalai/k-sdd/pull/56))

### Changed

- Command structure expanded from 8 to 11 commands
- Enhanced spec-design with flexible system flows and requirements traceability ([#55](https://github.com/gaebalai/k-sdd/pull/55))
...
- Commands: 11 (6 spec + 3 validate + 2 steering)
- Documentation Languages: 3 (English, Korean, Traditional Chinese)

**Related PRs:**

- [#56](https://github.com/gaebalai/k-sdd/pull/56) - Reorganize templates by OS and add Gemini CLI support
- [#55](https://github.com/gaebalai/k-sdd/pull/55) - Enhance technical design document generation
- [#54](https://github.com/gaebalai/k-sdd/pull/54) - Improve slash commands with individual arguments
- [#52](https://github.com/gaebalai/k-sdd/pull/52) - Add Cursor agent manifest and CLI support
...
- k-sdd npm package for easy distribution ([#39](https://github.com/gaebalai/k-sdd/pull/39))
- Complete CLI tool with `npx k-sdd@latest` installation
...
- Individual argument handling (`$1`, `$2`) instead of `$ARGUMENTS` ([#54](https://github.com/gaebalai/k-sdd/pull/54))

### Fixed

- Context creation optimization in template processing ([#45](https://github.com/gaebalai/k-sdd/pull/45))
...
- [#54](https://github.com/gaebalai/k-sdd/pull/54) - Improve slash commands with individual arguments
- [#52](https://github.com/gaebalai/k-sdd/pull/52) - Add Cursor agent support
- [#51](https://github.com/gaebalai/k-sdd/pull/51) - Major enhancement of kiro commands
- [#45](https://github.com/gaebalai/k-sdd/pull/45) - Optimize context creation performance
- [#43](https://github.com/gaebalai/k-sdd/pull/43) - Add CI/CD workflow
- [#42](https://github.com/gaebalai/k-sdd/pull/42) - Refactor README structure
- [#39](https://github.com/gaebalai/k-sdd/pull/39) - Add gemini-cli integration and k-sdd tool
- [#37](https://github.com/gaebalai/k-sdd/pull/37) - Release v1.0.0-beta.1
- [#36](https://github.com/gaebalai/k-sdd/pull/36) - Initial CLI tool release
...
- Applied optimization across all language versions (Korean, English, Traditional Chinese)
...
- **Release Notes**:
  ...
  - [English](docs/RELEASE_NOTES/RELEASE_NOTES_en.md)
- **Documentation**:
  - [English](tools/k-sdd/README.md)
  - [Korean](tools/k-sdd/README_ko.md)
