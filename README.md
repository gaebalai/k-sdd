...
Package README: <a href="./tools/k-sdd/README.md">English</a> | <a href="./tools/k-sdd/README_ko.md">한국어</a>
</sub></div>
...
Full rationale, trade-offs, and when-to-use / when-not-to-use: [Why k-sdd? A philosophy note](docs/guides/why-k-sdd.md).
...
```bash
npx k-sdd@latest                     # Claude Code Skills (default)
npx k-sdd@latest --claude-skills     # Claude Code Skills
npx k-sdd@latest --codex-skills      # Codex Skills
npx k-sdd@latest --cursor-skills     # Cursor IDE Skills (beta)
npx k-sdd@latest --copilot-skills    # GitHub Copilot Skills (beta)
npx k-sdd@latest --windsurf-skills   # Windsurf IDE Skills (beta)
npx k-sdd@latest --opencode-skills   # OpenCode Skills (beta)
npx k-sdd@latest --gemini-skills     # Gemini CLI Skills (beta)
npx k-sdd@latest --antigravity       # Antigravity Skills (beta, experimental)
```
...
npx k-sdd@latest --opencode-agent # OpenCode subagents (use --opencode-skills)
npx k-sdd@latest --gemini         # Gemini CLI commands (use --gemini-skills)
npx k-sdd@latest --codex          # Codex (blocked, use --codex-skills)
...
| ----------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| **Skill Reference**     | Skills-mode workflow, supporting skills, `/kiro-impl` subagent flow, Skills vs `--claude-agent` | [English](docs/guides/skill-reference.md) \| [한국어](docs/guides/ko/skill-reference.md)         |
| **Command Reference**   | Legacy `/kiro:*` commands with detailed usage, parameters, and examples                         | [English](docs/guides/command-reference.md) \| [한국어](docs/guides/ko/command-reference.md)     |
| **Customization Guide** | Practical examples: PRD requirements, frontend/backend designs, JIRA integration                | [English](docs/guides/customization-guide.md) \| [한국어](docs/guides/ko/customization-guide.md) |
| **Spec-Driven Guide**   | Complete workflow methodology from requirements to implementation                               | [English](docs/guides/spec-driven.md) \| [한국어](docs/guides/ko/spec-driven.md)                 |
| **Why k-sdd?**          | Design rationale, trade-offs, when the tool fits and when it does not                           | [English](docs/guides/why-k-sdd.md) \| [한국어](docs/guides/ko/why-k-sdd.md)                     |
| **Claude Subagents**    | Legacy `--claude-agent` install target and its spec-quick subagent flow                         | [English](docs/guides/claude-subagents.md) \| [한국어](docs/guides/ko/claude-subagents.md)       |
| **Migration Guide**     | Upgrading from v1.x / v2.x                                                                      | [English](docs/guides/migration-guide.md) \| [한국어](docs/guides/ko/migration-guide.md)         |
