...
> Need the legacy flow? Use `npx k-sdd@0.5.0`. Upgrading from v1.x?
> See the Migration Guide: [English](../../docs/guides/migration-guide.md) | [한국어](../../docs/guides/ko/migration-guide.md).

## 🚀 Installation

Run one command to install **AI-DLC** (AI Driven Development Lifecycle) with **SDD** (Spec-Driven Development) workflows across your preferred AI coding agent. k-sdd also scaffolds team-aligned templates so generated requirements, design reviews, task plans, and steering docs fit your approval flow.
...
... (en, ko, zh-TW, zh, es, pt, de, fr, ru, it, ja, ar supported)

# With agent options (default: claude-code / --claude)
npx k-sdd@latest --claude        # Claude Code (11 commands, en/ja/zh-TW/...)
npx k-sdd@latest --claude-agent --lang ko  # Claude Code Subagents (12 commands + 9 subagents)
npx k-sdd@latest --cursor --lang zh-TW     # Cursor IDE (choose any supported lang)
npx k-sdd@latest --gemini --lang es        # Gemini CLI
npx k-sdd@latest --codex --lang fr         # Codex CLI
npx k-sdd@latest --copilot --lang pt       # GitHub Copilot
npx k-sdd@latest --qwen --lang de          # Qwen Code
...
**Usage**: `npx k-sdd@latest --lang <code>` (e.g., `--lang ko` for Korean)
...
![design.md - System Flow Diagram](https://raw.githubusercontent.com/gotalab/k-sdd/refs/heads/main/assets/design-system_flow.png)
...
📖 **[Complete Command Reference](https://github.com/gotalab/k-sdd/blob/main/docs/guides/command-reference.md)** - Detailed usage, parameters, examples, and troubleshooting for all commands
...
📖 **[Customization Guide](https://github.com/gotalab/k-sdd/blob/main/docs/guides/customization-guide.md)** — 7 practical examples with copy-paste snippets
...
npx k-sdd@latest --lang ko            # macOS / Linux / Windows (auto-detected)
npx k-sdd@latest --lang ko --os mac   # Optional explicit override (legacy flag)
...
- Command Reference: [English](../../docs/guides/command-reference.md) | [한국어](../../docs/guides/ko/command-reference.md)
- Customization Guide: [English](../../docs/guides/customization-guide.md) | [한국어](../../docs/guides/ko/customization-guide.md)
- Spec-Driven Guide: [English](../../docs/guides/spec-driven.md) | [한국어](../../docs/guides/ko/spec-driven.md)
- Claude Subagents Guide: [English](../../docs/guides/claude-subagents.md) | [한국어](../../docs/guides/ko/claude-subagents.md)
- Migration Guide: [English](../../docs/guides/migration-guide.md) | [한국어](../../docs/guides/ko/migration-guide.md)
- **[Issues & Support](https://github.com/gotalab/k-sdd/issues)** - Bug reports and questions
- **[Kiro IDE](https://kiro.dev)**

---

**Stable Release v1.0.0** - Production-ready. [Report issues](https://github.com/gaebalai/k-sdd/issues) | MIT License
