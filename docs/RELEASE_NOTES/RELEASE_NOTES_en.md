...
New features and improvements for k-sdd. See [CHANGELOG.md](../../CHANGELOG.md) for technical changes.

---

## 🔬 In Development (Unreleased)

No unreleased features at this time. The latest stable release is v3.0.5.

---

## 🔧 Ver 3.0.5 (2026-04-06) – Patch Fixes & Docs Cleanup

### Summary

Patch release that keeps the Codex `spec-reviewer` role valid for cross-spec review and removes a README reference that no longer aligns with k-sdd.

### Fixed

- Added the missing `description` field to the Codex `spec-reviewer` template so Codex keeps the custom role available instead of ignoring it as malformed ([#160](https://github.com/gaebalai/k-sdd/pull/160))

### Documentation

- Removed the README Amazon book reference after the linked title shifted to promote `ai-sdd`, a closed-source clone of k-sdd without attribution ([#157](https://github.com/gaebalai/k-sdd/pull/157))
...
Patch release focused on safer filesystem handling in `k-sdd`, plus a small follow-up fix for mojibake and English wording.

### Fixed

- Fixed the mojibake in the Claude Code Skills `kiro-impl` template so the feature-flag protocol renders the `→` arrow correctly ([#154](https://github.com/gaebalai/k-sdd/pull/154))

### Security

- Hardened manifest, template, and shared-rule path handling so generated file operations stay within their expected roots
- Rejected unsafe traversal-style inputs and writes through symlinked destinations during execution ([#155](https://github.com/gaebalai/k-sdd/pull/155))

### Documentation

- Updated a few English docs lines to replace `team-scale AI-driven development` with the more natural `AI-driven development at team scale` ([#155](https://github.com/gaebalai/k-sdd/pull/155))
...
- **Agent Skills as the primary workflow**: k-sdd now centers on `--*-skills` installs and a unified 17-skill workflow across 8 platforms.
...
- **Native subagent dispatch**: autonomous implementation, review, and debug loops now live inside k-sdd without relying on the external Ralph Loop project.

### ✨ Added

- Skills-based agents for Cursor, GitHub Copilot, OpenCode, Gemini CLI, Windsurf, and Antigravity, alongside upgraded Claude Code Skills and Codex Skills support ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- New workflow entry points:
  ...
  - `/kiro-impl` for autonomous implementation with reviewer/debugger loops ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- New rules/templates for boundary-first planning, design synthesis, review gates, task decomposition, and steering customization under `.kiro/settings/` ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- `k-sdd-new-agent`, a SOP-style skill for adding or migrating supported agents ([#141](https://github.com/gaebalai/k-sdd/pull/141))

### 🔧 Changed

- Default install target is now `claude-code-skills`, making skills mode the out-of-the-box experience ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Documentation, onboarding, and positioning have been rewritten around the v3 workflow and “long-running autonomous implementation” model ([#141](https://github.com/gaebalai/k-sdd/pull/141))
- Issue auto-close automation now activates only when maintainers intentionally apply the `awaiting-response` label ([#138](https://github.com/gaebalai/k-sdd/pull/138))
...
* Resources: [CHANGELOG.md](../../CHANGELOG.md#211---2026-02-02), PRs: [#134](https://github.com/gaebalai/k-sdd/pull/134), [#135](https://github.com/gaebalai/k-sdd/pull/135)
...
- **OpenCode** ([#117](https://github.com/gaebalai/k-sdd/pull/117), [#127](https://github.com/gaebalai/k-sdd/pull/127))
  ...
  - Installation: `npx k-sdd@latest --opencode` or `--opencode-agent`

### 🔧 Changed

- Updated recommended models ([#128](https://github.com/gaebalai/k-sdd/pull/128), [#129](https://github.com/gaebalai/k-sdd/pull/129))
  - Claude: Opus 4.5
  - OpenAI: GPT-5.2
...
* Resources: [CHANGELOG.md](../../CHANGELOG.md#210---2026-02-01), PRs: [#117](https://github.com/gaebalai/k-sdd/pull/117), [#127](https://github.com/gaebalai/k-sdd/pull/127), [#128](https://github.com/gaebalai/k-sdd/pull/128), [#129](https://github.com/gaebalai/k-sdd/pull/129)
...
* Resources: [CHANGELOG.md](../../CHANGELOG.md#205---2026-01-08), PR: [#121](https://github.com/gaebalai/k-sdd/pull/121)
...
- Added AI-Assisted SDD book reference to k-sdd documentation.
...
* Resources: [CHANGELOG.md](../../CHANGELOG.md#204---2026-01-07), PRs: [#118](https://github.com/gaebalai/k-sdd/pull/118), [#109](https://github.com/gaebalai/k-sdd/pull/109), [#107](https://github.com/gaebalai/k-sdd/pull/107)
...
- Resources: [CHANGELOG.md](../../CHANGELOG.md#203---2025-11-15), PR: [#104](https://github.com/gaebalai/k-sdd/pull/104)
...
- Resources: [CHANGELOG.md](../../CHANGELOG.md#202---2025-11-15), PR: [#102](https://github.com/gaebalai/k-sdd/pull/102)
...
- PRs: [#93](https://github.com/gaebalai/k-sdd/pull/93), [#94](https://github.com/gaebalai/k-sdd/pull/94)
...
- **`npx k-sdd@latest` = full stack SDD**: all alpha capabilities (research.md, validation commands, Subagents, Windsurf) are now GA.
...
2. Update automation/scripts to call `npx k-sdd@latest` (the `@next` tag is reserved for future previews).
...
- PLAN references: `docs/k-sdd/v2.0.0/PLAN.md` for release tasks, `docs/k-sdd/v2.0.0/PLAN2.md` for design-template scope.
...
- Updated EARS format to lowercase syntax ([#88](https://github.com/gaebalai/k-sdd/pull/88))
  - Changed from "WHILE/WHEN/WHERE/IF" to "while/when/where/if"
  - More natural and readable requirements description
- Clarified installation documentation ([#87](https://github.com/gaebalai/k-sdd/pull/87))
- Added npm `next` version badge to README files ([#86](https://github.com/gaebalai/k-sdd/pull/86))
...
- **Customization Guide** ([#83](https://github.com/gaebalai/k-sdd/pull/83))
  - Template customization patterns
  - Agent-specific workflow examples
  - Project-specific rule examples
  - 7 practical customization examples
- **Command Reference** ([#83](https://github.com/gaebalai/k-sdd/pull/83))
...
- **Windsurf IDE support**: Added a dedicated manifest, workflow templates under `.windsurf/workflows/`, and an AGENTS.md quickstart so Windsurf users can run the full kiro Spec-Driven Development workflow with `npx k-sdd@next --windsurf`.
...
- Refreshed the root README, CLI docs (`tools/k-sdd/README*`), and legacy guides (`docs/README/README_{en,ko}.md`) with Windsurf instructions, updated quick-start matrices, and the manual QA checklist using `npx k-sdd@next --windsurf`.
...
- **GitHub URL updates** - Migration support to gaebalai/k-sdd
...
- Implemented unified optimization across Korean, English, and Traditional Chinese versions
