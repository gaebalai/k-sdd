...
> ⚠️ **Legacy documentation (archived).** This page reflects an early k-sdd workflow and is kept for reference only. For the latest instructions, see the [current README](../../README.md).

> 🌐 **Language**  
> 📖 **English Version** (This page) | 📖 **[한국어판 README](README_ko.md)**
...
├── README.md              # Korean version README
